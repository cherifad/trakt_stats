...
export function StatCard({
  ...
  return (
    ...
    >
      <Card
        className={`glass border-white/10 overflow-hidden group relative h-full ${
          className || ""
        }`}
      >
        ...
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative">
          ...
          {Icon && (
            ...
            >
              <Icon className="h-4 w-4 sm:h-5 sm:w-5 text-primary/60 group-hover:text-primary transition-colors" />
            </motion.div>
          )}
        </CardHeader>
