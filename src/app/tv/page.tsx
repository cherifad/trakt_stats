      ...
      >
        <motion.div variants={item}>
          <StatCard
            ...
            icon={Play}
            description={`${tv.stats.plays.per_day.toFixed(1)} ${t(
              "dashboard.perDay"
            )}`}
          />
        </motion.div>
        <motion.div variants={item}>
          <StatCard
            ...
            icon={Clock}
            description={`${tv.stats.hours.per_month.toFixed(1)} ${t(
      ...
      >
        ...
        >
          {Object.entries(tv.highest_rated).map(([id, show]) => (
            <motion.div key={id} variants={item}>
              <MediaCard poster={show.poster} rating={show.rating} />
            </motion.div>
          ))}
        </motion.div>
      </motion.div>
                        ...
                        <motion.div
                          ...
                          animate={{
                            width: `${
                              (item.value /
                                Math.max(
                                  ...Object.values(tv.by_released_year)
                                )) *
                              100
                            }%`,
                          }}
